...
namespace AuthWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                user.SecurityQn1 = Input.SecurityQn1;
                user.SecurityAns1 = _hashingService.HashInput(Input.SecurityAns1);
                user.SecurityQn2 = Input.SecurityQn2;
                user.SecurityAns2 = _hashingService.HashInput(Input.SecurityAns2);
                user.SecurityQn3 = Input.SecurityQn3;
                user.SecurityAns3 = _hashingService.HashInput(Input.SecurityAns3);
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        TempData["success"] = "Registered sucessfully!!";
